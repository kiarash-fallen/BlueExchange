...
const SignIn = () => {
  ...
  return (
      <form className="grid grid-cols-2 grid-rows-4 justify-between" onSubmit={handleSubmit(onSubmit)}>
        <div className="relative w-[239px]">
          ...
          <label
            htmlFor="email"
            className="absolute -top-3 right-3 text-[#AAAAAA] px-1 bg-opacity-100 bg-[#252525] peer-focus:text-white"
          >
            ایمیل شما
          </label>
        </div>
