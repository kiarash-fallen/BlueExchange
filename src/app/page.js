...
import Security from '../../public/assests/images/Security.png';
import DisCount from '../../public/assests/images/SaleDiscount.png';
import Notifications from '../../public/assests/images/Notifications.png';
import PerfectMoney from '../../public/assests/images/PerfectMoney.png';
          ...
          <div className="flex flex-col mr-7">
            <div className="w-[132.92px] h-[73.92px] border border-[#3E3E3E] rounded-[32px] mt-6 z-30 bg-[#3D3D3D] bg-opacity-[48%] mx-auto">
              <Image
                ...
                height={150}
                alt="PerfectMoney"
                className="-mt-14 m-auto max-w-[110%]"
              />
            </div>
            <div className="BoxShadow h-[149.96px] w-[186.24px] bg-[#363636] bg-opacity-[48%] rounded-[32px] -mt-10 flex items-center justify-center font-semibold text-2xl text-center">
